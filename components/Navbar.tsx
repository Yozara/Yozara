            ...
            {!loading && user ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/10 transition-colors text-white/70 hover:text-white"
                >
                  <Bookmark size={18} />
                ...
                <div className="relative">
                  ...
                  {menuOpen && (
                    <div className="absolute right-0 top-12 w-48 backdrop-blur-md bg-white/5 border border-white/10 rounded-xl overflow-hidden shadow-xl">
                      ...
                      <Link
                        href="/profile"
                        className="flex items-center gap-3 px-4 py-3 text-white/80 hover:text-white hover:bg-white/10 transition-all border-b border-white/5"
                      >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 text-red-400/80 hover:text-red-400 hover:bg-red-400/10 transition-all"
                      >
                        <LogOut size={16} />
                        <span>Log Out</span>
                      </button>
              ...
              <>
                ...
                <Link href="/login">
                  <Button
                    variant="ghost"
                    className="text-white/80 hover:text-white hover:bg-white/5 hidden sm:flex"
                  >
                    Log in
                  </Button>
                </Link>
